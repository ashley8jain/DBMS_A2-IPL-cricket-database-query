...
\copy player(player_id, player_name, dob, batting_hand, bowling_skill, country_name) FROM '/Users/ashleyjain/Desktop/github2/player.csv' DELIMITER ',';

--TABLE 2--

CREATE TABLE team(team_id int PRIMARY KEY, name text);

\copy team(team_id, name) FROM '/Users/ashleyjain/Desktop/github2/team.csv' DELIMITER ',';
...
\copy match(match_id, team_1, team_2, match_date, season_id, venue, toss_winner, toss_decision, win_type, win_margin, outcome_type, match_winner, man_of_the_match) FROM '/Users/ashleyjain/Desktop/github2/match.csv' DELIMITER ',';
...
\copy player_match(match_id, player_id, role, team_id) FROM '/Users/ashleyjain/Desktop/github2/player_match.csv' DELIMITER ',';
...
\copy ball_by_ball(match_id, over_id, ball_id, innings_no, team_batting, team_bowling, striker_batting_position, striker, non_striker, bowler) FROM '/Users/ashleyjain/Desktop/github2/ball_by_ball.csv' DELIMITER ',';
...
\copy batsman_scored(match_id, over_id, ball_id, runs_scored, innings_no) FROM '/Users/ashleyjain/Desktop/github2/batsman_scored.csv' DELIMITER ',';
...
\copy wicket_taken(match_id, over_id, ball_id, player_out, kind_out, innings_no) FROM '/Users/ashleyjain/Desktop/github2/wicket_taken.csv' DELIMITER ',';
...
\copy extra_runs(match_id, over_id, ball_id, extra_type, extra_runs, innings_no) FROM '/Users/ashleyjain/Desktop/github2/extra_runs.csv' DELIMITER ',';
